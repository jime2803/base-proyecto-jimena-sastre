  ...
  return (
    <Layout>
      ...
      <section>
        ...
        <ul>
          <li>
            <h3><i className="fas fa-truck"></i> Envíos a todo el país</h3>
            <p>Recibí tu compra en la puerta de tu casa estés donde estés.</p>
          </li>
          <li>
            <h3><i className="fas fa-credit-card"></i> Pagos seguros</h3>
            <p>Trabajamos con plataformas que garantizan tu seguridad.</p>
          </li>
          <li>
            <h3><i className="fas fa-bullseye"></i> Atención personalizada</h3>
